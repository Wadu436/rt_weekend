...
bool lambertian::scatter(const ray &ray_in, const hit_record &rec,
...
bool metal::scatter(const ray &ray_in, const hit_record &rec,
                    color &attenuation, ray &scattered) const {
...
bool dielectric::scatter(const ray &ray_in, const hit_record &rec,
                         color &attenuation, ray &scattered) const {
